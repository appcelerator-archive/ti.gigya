...
- (id)init {
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    // Appcelerator
    /*
    UIImage* iconImage = [UIImage imageNamed:@"GSFBDialog.bundle/images/fbicon.png"];
    UIImage* closeImage = [UIImage imageNamed:@"GSFBDialog.bundle/images/close.png"];
    */
    UIImage* iconImage = [UIImage imageNamed:@"modules/ti.gigya/GSFBDialog.bundle/images/fbicon.png"];
    UIImage* closeImage = [UIImage imageNamed:@"modules/ti.gigya/GSFBDialog.bundle/images/close.png"];
    // Appcelerator
    ...
    CGFloat titleLabelFontSize = (GSFBIsDeviceIPad() ? 18 : 14);
...
- (id)initWithURL: (NSString *) serverURL
         ...
         delegate: (id <GSFBDialogDelegate>) delegate {
