...
+ (GSFBRequest *)getRequestWithParams:(NSMutableDictionary *) params
                         httpMethod:(NSString *) httpMethod
                           delegate:(id<GSFBRequestDelegate>) delegate
                         requestURL:(NSString *) url {
  GSFBRequest* request = [[[GSFBRequest alloc] init] autorelease];
...
- (id)parseJsonResponse:(NSData *)data error:(NSError **)error {
  ...
  NSString* responseString = [[[NSString alloc] initWithData:data
                              ...
                              autorelease];
  TiGigyaSBJSON *jsonParser = [[TiGigyaSBJSON new] autorelease];
